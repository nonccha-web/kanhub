          ...
          <div>
            ...
            <div className="mt-5 flex flex-wrap gap-2">
              <a
                ...
                className="rounded-lg bg-line px-3.5 py-2 text-sm font-semibold text-white transition-colors hover:bg-line-dark"
              >
                💬 แอด LINE
              </a>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="rounded-lg border border-white/20 px-3.5 py-2 text-sm font-medium text-white/80 transition-colors hover:border-white/40"
              >
                📘 Facebook
              </a>
            </div>
